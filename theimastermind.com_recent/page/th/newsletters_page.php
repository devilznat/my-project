<?php
  ...
  $id=$_GET["id"];
  $idpage = $id-1;
  $headlink = "newsletters_page?id=".$idpage;
  
   $strSQL = "SELECT * FROM newsletter WHERE language_code = 'th' AND nid = '$id' ";
...
<meta property="og:image" content="http://www.theimastermind.com/uploadfile/article/<? echo $rs["pic"]; ?>"/>
...
<meta name="twitter:image" content="http://www.theimastermind.com/uploadfile/article/<? echo $rs["pic"]; ?>" />
                        ...
                        <a href="newsletters_page?id=<? echo $rs["nid"]; ?>">
                            ...
                            <div class="news-v3-in">
                                <ul class="list-inline posted-info">
                                    ...
                                    <li>Posted <?echo $rs["created_date"];?></li>
                                </ul>
...
<a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=http%3A%2F%2Ftheimastermind.com%2Fpage%2Fen%2Fnewsletters_page?id=<?echo $id;?>&amp;title=<?echo $rs["topic"]?>.&amp;summary=<?$rs["value"];?>.&amp;source=http://www.theimastermind.com/uploadfile/article/<? echo $rs["pic"]; ?>" target="_blank" aria-label="Share on Linkedin">
 ...
 <?php
    ...
    ?>
                        ...
                        <!-- End News v3 -->
<?
                        $strSQL0 = "SELECT * FROM newsletter WHERE language_code = 'th' ORDER BY RAND()
LIMIT 2";
...
$date2 = date('M', $timestamp);
          ...
          <? } ?>
                    ...
                    <!-- End Blog All Posts -->
<?
$strSQL2 = "SELECT * FROM newsletter WHERE language_code = 'th' ORDER BY RAND()
LIMIT 3";
$result2 = mysql_query($strSQL2);

$strSQL3 = "SELECT * FROM newsletter WHERE language_code = 'th' ORDER BY nid DESC
LIMIT 4";
               ...
               while($rs2 = mysql_fetch_array($result2))  //สร้างตัวแปร $rs มารับค่าจากการ fetch array
{
                ?>
                            <li>
                                <h3><a href="newsletters_page?id=<? echo $rs2["nid"]; ?>"><? echo $rs2["topic"]; ?></a></h3>
               ...
               while($rs3 = mysql_fetch_array($result3))  //สร้างตัวแปร $rs มารับค่าจากการ fetch array
{
                ?>
                            <li>
                                <h3><a href="newsletters_page?id=<? echo $rs3["nid"]; ?>"><? echo $rs3["topic"]; ?></a></h3>
                                <small><? echo $rs3["created_date"]; ?> / <a href="newsletters_alltag?tag=<? echo $rs3["location"]; ?>"><? echo $rs3["location"]; ?></a></small>
