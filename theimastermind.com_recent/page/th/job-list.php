...
$getdata2 = str_replace(",", "", $getdata2);
 ...
 //  echo $getdata2;
  ...
  // echo $status;
   ...
   if ($status==0) {
      $number="SELECT * FROM jobs_value WHERE language_code = 'th' ";
  ...
  // ค้นหาจากหน้า index
    ...
    if ($getcategory == 'All' && $getindustries == 'All') {
      ...
      $number = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND language_code = 'th' ";
    }

    else if ($getcategory == 'All') {
      $number = "SELECT * FROM jobs_value WHERE industry like '%$getindustries%' AND language_code = 'th' ";
    }

    // else if ($getcategory != 'All' && $getindustries != 'All') {
    //   $sql = "SELECT * FROM jobs_value WHERE language_code = 'th'  ";
    // }

    else {

      $number = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th' ";
    }
    ...
    if ($getindustries == 'All' && $getcategory == 'All') {
      ...
      $number = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
    }

      

    else if ($getindustries == 'All') {
      $number = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND category like '%$getcategory%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
    }

    else if ($getcategory == 'All') {
      $number = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
    }

    else if ($getcategory != 'All' && $getindustries != 'All') {

      $number = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
    ...
    if ($getindustries == 'All' && $getcategory == 'All') {
      ...
      $number = "SELECT * FROM jobs_value WHERE language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2'  ";

    }

    else if ($getindustries == 'All') {
      $number = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
    }

    else if ($getcategory == 'All') {
      $number = "SELECT * FROM jobs_value WHERE industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2'";
    }

    else if ($getcategory != 'All' && $getindustries != 'All') {

      $number = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ";
...
$checknumpage = mysql_num_rows(mysql_query($number));
if ($checknumpage == 0) {
  $number = "SELECT * FROM jobs_value WHERE language_code = 'en' ";
}
...
$start=($page-1)*$rows;
  ...
  if ($status==0) {
    ...
    if ($getcategory == 'All' && $getindustries == 'All') {
      ...
      $sql = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND language_code = 'th' ORDER BY id DESC limit $start,5";
    }

    else if ($getcategory == 'All') {
      $sql = "SELECT * FROM jobs_value WHERE industry like '%$getindustries%' AND language_code = 'th'  ORDER BY id DESC limit $start,5";
    }


    else {

      $sql = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th'  ORDER BY id DESC limit $start,5";
    }
    ...
    if ($getindustries == 'All' && $getcategory == 'All') {
      ...
      $sql = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    }

      

    else if ($getindustries == 'All') {
      $sql = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND category like '%$getcategory%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    }

    else if ($getcategory == 'All') {
      $sql = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    }

    else if ($getcategory != 'All' && $getindustries != 'All') {

      $sql = "SELECT * FROM jobs_value WHERE title like '%$gettext%' AND category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    ...
    if ($getindustries == 'All' && $getcategory == 'All') {
      ...
      $sql = "SELECT * FROM jobs_value WHERE language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2'  ORDER BY id DESC limit $start,5 ";

    }

    else if ($getindustries == 'All') {
      $sql = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    }

    else if ($getcategory == 'All') {
      $sql = "SELECT * FROM jobs_value WHERE industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5 ";
    }

    else if ($getcategory != 'All' && $getindustries != 'All') {

      $sql = "SELECT * FROM jobs_value WHERE category like '%$getcategory%' AND industry like '%$getindustries%' AND language_code = 'th' AND salary_start >= '$getdata1' AND salary_end <= '$getdata2' ORDER BY id DESC limit $start,5";
...
$checknumsql = mysql_num_rows(mysql_query($sql));
if ($checknumsql == 0) {
  $sql= "SELECT * FROM jobs_value WHERE language_code = 'th'  ORDER BY id DESC limit $start,5";
...
<?
	...
	$sqlbannerjoblist1 = mysql_query("SELECT * FROM banner WHERE language_code =  'th' AND location = 'banner-joblist1' " );
	$loadbannerjoblist1 = mysql_fetch_array($sqlbannerjoblist1 );

	$sqlbannerjoblist2 = mysql_query("SELECT * FROM banner WHERE language_code =  'th' AND location = 'banner-joblist2' " );
	$loadbannerjoblist2 = mysql_fetch_array($sqlbannerjoblist2 );

	$sqlbannerjoblist3 = mysql_query("SELECT * FROM banner WHERE language_code =  'th' AND location = 'banner-joblist3' " );
	...
	?>
				...
				<div class="news-v3 bg-color-white margin-bottom-10">
					...
					<div class="row blog-job">
						<div class="col-md-2">
							<img src="../../assets/img/job/<? echo $rs["value_custom"]; ?>" class="img-responsive  imgjob demo" alt="">
						</div>
						<div class="col-md-7">
