...
<body class="header-fixed header-fixed-space">
	<div class="wrapper">
		...
		$sqlheadservice = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'head-service' " );
		...
		$sqlservicedetail1 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'service-detail1' " );
		$loadservicedetail1 = mysql_fetch_array($sqlservicedetail1);

		$sqlservicedetail2 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'service-detail2' " );
		$loadservicedetail2 = mysql_fetch_array($sqlservicedetail2);

		$sqlservicedetail3 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'service-detail3' " );
		...
		$sqlparallax1 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'parallax-1' " );
		$loadparallax1 = mysql_fetch_array($sqlparallax1);

		$sqlparallax2 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'parallax-2' " );
		$loadparallax2 = mysql_fetch_array($sqlparallax2);

		$sqlparallax3 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'parallax-3' " );
		$loadparallax3 = mysql_fetch_array($sqlparallax3);

		$sqlparallax4 = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'parallax-4' " );
		...
		<?
		$sqlquoteservice = mysql_query("SELECT * FROM our_service WHERE language_code =  'th' AND location = 'quote-service' " );
