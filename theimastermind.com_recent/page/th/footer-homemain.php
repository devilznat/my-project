...
?>
	...
	<?
	$sqlfooter = mysql_query("SELECT * FROM footer WHERE language_code =  'th' AND location = 'footer-title' " );
	$loadfooter = mysql_fetch_array($sqlfooter);

	$sqlfootersocial = mysql_query("SELECT * FROM footer WHERE language_code =  'th' AND location = 'footer-social' " );
	...
	<section id="contact" class="custom-contacts-section">
		...
		<div class="custom-copyright-section">
			...
			<ul class="social-icons">
				...
				<li><a href="<? echo $loadfootersocial[value_custom3]; ?>" data-original-title="Pinterest" class="social_pintrest rounded-x"></a></li>
