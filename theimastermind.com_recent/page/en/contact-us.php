...
<head>
	<title>Contact Us | The i Mastermind </title>
	...
	<div class="wrapper">
		...
		<div class="container content">
			<div class="row margin-bottom-30">
					...
					<fieldset>
							...
							<section class="col-md-12">
								<label class="textarea">
									...
									<textarea rows="5" name="text7" id="text7" placeholder="Tell us more"></textarea>
								</label>
								</section>
							</div>
						</fieldset>
				...
				<div class="col-md-3">
					<!-- Contact -->
                    <div class="headline"><h2><? /*echo $loadcontactDetail1[key];*/ ?>Contact</h2></div>
	...
	<script type="text/javascript" src="assets/js/forms/checkout.js"></script>
		...
		$.ajax({
		    ...
		    success:  function(data){
		        ...
		        window.location.assign("http://theimastermind.com/page/email-templates/sendmail-contactus.php"+data);
		    }
		});
