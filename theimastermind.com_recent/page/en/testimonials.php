...
?>
	<div class="wrapper">
		...
		$sqlheadtestimonials = mysql_query("SELECT * FROM testimonials WHERE language_code =  'en' AND location = 'head-testimonials' " );
		...
		<div class="container content-sm hidden ">
			<!-- <div class="headline-center margin-bottom-60">
				<h2>What Our <strong><font color="#CEE9FF">Clients Say?</font> </strong></h2>
