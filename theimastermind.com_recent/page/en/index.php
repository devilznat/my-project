...
$strSQL = "SELECT * FROM jobs_value WHERE language_code = 'en' ORDER BY id DESC limit 0,5 ";
				 ...
				 <form class="shipping-form">
	              ...
	              <div class="row">
	                ...
	                <!-- ซ่อน respon ใหญ่ -->
	                 <select class="formselet2 rounded-3x input-lg  col-lg-4 col-md-4 hidden-md hidden-lg"   name="Category" id="Category">
	                   <option value="All">All Categories</option>
                        ...
                        <option value="Engineer">Engineering</option>
                        <option value="Account">Finance/Accounting</option>
                        <option value="COOK">Food and Beverage/Chef/Cook/Bar Tender/Waiter</option>
                        <option value="Garment">Garment</option>
                        <option value="41">Geographic/Mapping/GIS</option>
                        <option value="HealthCare">Healthcare/Fitness/Spa</option>
                        <option value="HouseKeeper">House Keeper / Gardener</option>
                        <option value="BOI">Import-Export/Shipping/BOI</option>
                        <option value="GUIDE">Interpreter/Tourist Guide/Reservation</option>
	                ...
	                <select class="formselet2 rounded-3x input-lg  col-lg-4 hidden-md hidden-lg" name="Industries" id="Industries">
	                   <option value="All">All Industries</option>
                        <option value="38">Accounting and Law Service</option>
                        ...
                        <option value="27">Chemical/Plastic</option>
                        <option value="5">Computer/IT</option>
                        <option value="21">Construction</option>
                        <option value="10">Consulting</option>
                        <option value="25">Design/Interior Design</option>
                        <option value="3">Education</option>
                        <option value="30">Electrical</option>
                        <option value="33">Electronic</option>
                        <option value="16">Energy</option>
                        <option value="14">Entertaining</option>
                        <option value="8">Finance</option>
                        <option value="26">Food, Drink &amp; Tobacco</option>
                        <option value="41">Furniture/Appliance</option>
                        <option value="32">Garment</option>
                        <option value="35">Government/Non-profit</option>
                        <option value="19">Hospital/Clinic</option>
                        <option value="20">Hotel/Resort/Spa/Golf Club</option>
                        <option value="22">Import/Export</option>
                        <option value="15">Insurance</option>
                        <option value="34">Jewelry</option>
                        <option value="39">Loan/Credit Card</option>
                        <option value="37">Mass Communication</option>
                        <option value="18">Medicine/Cosmetic/Medical Equipment</option>
                        <option value="29">Packaging</option>
                        <option value="28">Paper</option>
                        <option value="2">Publishing/Printing</option>
                        ...
                        <option value="40">Steel/Metal</option>
                        <option value="23">Telecommunication</option>
                        <option value="17">Trading/Commerce</option>
