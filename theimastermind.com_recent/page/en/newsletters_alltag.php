...
if($alltag == 6) 
{
	...
	$rows= 6;
if($page<=0) $page=1;
$total_data=mysql_num_rows(mysql_query("SELECT * FROM newsletter WHERE language_code = 'en'  "));
...
$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' ORDER BY nid DESC limit $start,6";
...
$rows= 6;
if($page<=0) $page=1;
$total_data=mysql_num_rows(mysql_query("SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '$alltag' "));
$total_page=ceil($total_data/$rows);
if($page>=$total_page) $page=$total_page;
...
$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '$alltag' ORDER BY nid DESC limit $start,6";
$result = mysql_query($strSQL);
		...
		?>
						...
						<div class="col-md-12 news-v3">
							<div class="news-v3-in-sm no-padding">
								...
								<button class="btn-u rounded-3x btn-u-yellow" type="button"><i class=""></i> Read more..</button> 
								    </a>
								</div>
								<br>
							</div>
