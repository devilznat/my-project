...
$loadidresume = mysql_fetch_array($sql);
 ...
 ?>
					...
					<input type="text" name="type" id="type" value="uploadresumenojob" hidden>
		...
		// upload file banner newsletters1 eng
		  ...
		  var uploader = new ss.SimpleUpload({
		        button: btn,
		        url: 'fileupload-uploadresumenojob?idresume=<? echo $idresume;?>',
		        name: 'uploadresumenojob',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
			 ...
			 function uploadresume(){
				...
				$.ajax({
				    ...
				    success:  function(data){
				        ...
				        var sendaposition = $('#aposition').val();

				        var data = "?firstname="+sendfirstname+"&lastname="+sendlastname+"&email="+sendemail+"&phone="+sendphone+"&aposition="+sendaposition;

		       		 	window.location.assign("http://theimastermind.com/page/email-templates/sendmail-uploadresume.php"+data);
