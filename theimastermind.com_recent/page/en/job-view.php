...
$strSQL2 = "SELECT * FROM jobs_value WHERE language_code = 'en' ORDER BY RAND()
LIMIT 5";
...
$num2 = number_format($s2);
				...
				<div class="row">
					...
					<div class="col-md-3 blog-paddingbtn">
						...
						<a href="upload-resume?jobid=<? echo $rs["id"]; ?>" 
						class="btn btn-success btn-lg rounded-2x btn-block margin-bottom-20">
