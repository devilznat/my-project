...
<body class="header-fixed header-fixed-space">
	<div class="wrapper">
		...
		$sqlheadrecruit = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'head-recruitment' " );
		...
		?>
			...
			$sqlstep1 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-1' " );
			$loadstep1 = mysql_fetch_array($sqlstep1);

			$sqlstep2 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-2' " );
			$loadstep2 = mysql_fetch_array($sqlstep2);

			$sqlstep3 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-3' " );
			$loadstep3 = mysql_fetch_array($sqlstep3);

			$sqlstep4 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-4' " );
			$loadstep4 = mysql_fetch_array($sqlstep4);

			$sqlstep5 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-5' " );
			$loadstep5 = mysql_fetch_array($sqlstep5);

			$sqlstep6 = mysql_query("SELECT * FROM recruitment_procedure WHERE language_code =  'en' AND location = 'step-6' " );
