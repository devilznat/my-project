...
<?
	$sqltitlecorp1 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'title-head' " );
...
?>
		...
		<div class="bg-color-light">
			<div class="container content-sm" >
				...
				<!-- <div class="headline-center margin-bottom-60">
					...
					<?
					$sqldetailcorp1 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'detail-corp' " );
					$loaddetailcorp1 = mysql_fetch_array($sqldetailcorp1);

					$sqlbuttondetail = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'button-detail' " );
					$loadbuttondetail = mysql_fetch_array($sqlbuttondetail);

					$sqllinkyoutube = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'link-youtube' " );
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="responsive-video">
								<iframe width="100%" src="<? echo $loadlinkyoutube[key]; ?>?autoplay=1" frameborder="0" allowfullscreen></iframe>
							</div>
							<!-- <? echo $loadlinkyoutube[key]; ?> -->
		...
		<!--=== Title v1 ===-->
					...
					<?
					$sqldetail2 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'detail-2' " );
		...
		<div class="container content-sm">
			...
			<!--=== End Title v1 ===-->
					...
					<?
					$sqlicon1 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-1' " );
					$loadicon1 = mysql_fetch_array($sqlicon1);

					$sqlicon2 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-2' " );
					$loadicon2 = mysql_fetch_array($sqlicon2);

					$sqlicon3 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-3' " );
					$loadicon3 = mysql_fetch_array($sqlicon3);

					$sqlicon4 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-4' " );
					$loadicon4 = mysql_fetch_array($sqlicon4);

					$sqlicon5 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-5' " );
					$loadicon5 = mysql_fetch_array($sqlicon5);

					$sqlicon6 = mysql_query("SELECT * FROM corporate_overview WHERE language_code =  'en' AND location = 'icon-6' " );
