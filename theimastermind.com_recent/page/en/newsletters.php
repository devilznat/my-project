...
function returnRecents()
{
	...
	$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en'  ORDER BY nid desc LIMIT 3 ";
...
function returnPopulars()
{
	...
	$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '4' ORDER BY nid desc LIMIT 3 ";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$resultArray = array();
	while($obResult = mysql_fetch_array($objQuery))
	{
...
function returnKnowledge()
{
	...
	$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '3' ORDER BY nid desc LIMIT 4 ";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$resultArray = array();
	while($obResult = mysql_fetch_array($objQuery))
	{
...
function returnArticles()
{
	...
	$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '1' ORDER BY nid desc LIMIT 4 ";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$resultArray = array();
	while($obResult = mysql_fetch_array($objQuery))
	{
...
function returnTips()
{
	...
	$strSQL = "SELECT * FROM newsletter WHERE language_code = 'en' AND category_id = '2' ORDER BY nid desc LIMIT 4 ";
	$objQuery = mysql_query($strSQL) or die (mysql_error());
	$resultArray = array();
	while($obResult = mysql_fetch_array($objQuery))
	{
				...
				<!-- Blog All Posts -->
						...
						<div class="col-md-4 <?php echo $result["value"];?> ">
							...
							<div class="news-v2-desc bg-color-light">
								<h4 class="headblog"><a href="newsletters_page?id=<? echo $result["nid"]; ?>"><b><?php echo $result["topic"];?></b</a></h4>
