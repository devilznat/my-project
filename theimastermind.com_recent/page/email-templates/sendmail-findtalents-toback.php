...
$showemail = $_SESSION["emailft"];
	...
	$body1 = file_get_contents('email-findtalents-toback.html');
...
$mail->Subject = 'You have a new Message from Find Talents - TheiMastermind';
$mail->Body = $body1;
$mail->AltBody = '';
...
if(!$mail->send()) {
    ...
    echo "<script>window.location = '../en/find-talents'</script>";
}
