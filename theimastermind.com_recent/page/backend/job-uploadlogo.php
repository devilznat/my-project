				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
								<div class="col-md-12">
								<H4><b>Upload Logo Job</b></H4>
								
								</div>
								<div class="col-md-4"></div>
								<div class="col-md-6">
								<H4><b>Job Name : </b> <? echo $loadjob[title];?></H4>
								<H4><b>Salary  : </b><? echo $loadjob[salary_start];?> - <? echo $loadjob[salary_end];?> THB</H4>
								</div>
								<div class="col-md-2"></div>
								<div class="col-md-12">
								<H5>*Image Size 480x480 </h5>
								</div>
							...
							<div class="col-md-12">
							<hr>
							<a class="btn-u pull-left" href="job-preview?idjob=<? echo $getidjob;?>" >Save and Preview Job</a>		
							</div>			
						</div>
					</div>
					<!-- End Logo -->				
