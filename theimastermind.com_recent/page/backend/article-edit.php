...
$sqlen = mysql_query("SELECT * FROM  newsletter WHERE article_id = '$getidarticle'  AND language_code = 'en'  " );
$loaden = mysql_fetch_array($sqlen);
 
$sqlth = mysql_query("SELECT * FROM  `newsletter` WHERE article_id = '$getidarticle' AND language_code = 'th' " );
...
?>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
								...
								<form name="form1" id="form1" class="sky-form">
							 	<input type="text" name="type" id="type" value="edit-article" hidden>
							 	<input type="text" name="articleid" id="articleid" value="<? echo $idarticle; ?>" hidden>
								...
								<div class="row">
									...
									<label class="label">Categories</label>
										...
										<label class="select">	
							                <select name="text1" id="text1">
							   					<option value="1" <?php if($loaden[category_id]== "1") echo 'selected="selected"'; ?>>Articles</option>
						                        <option value="2" <?php if($loaden[category_id]== "2") echo 'selected="selected"'; ?>>Tips</option>
						                        <option value="3" <?php if($loaden[category_id]== "3") echo 'selected="selected"'; ?>>Knowledge</option>
						                        <option value="4" <?php if($loaden[category_id]== "4") echo 'selected="selected"'; ?>>Populars/Referral</option>
							                </select>
							                <i></i>
										</label>
									...
									<section class="col-md-12">
									<label class="label">Image Article</label>

										
									
										<img src="../../uploadfile/article/<? echo $loaden["pic"]; ?>" class="img-responsive">

									</section>

									<section class="col col-12">
											<label class="label">*Image Size 1200x420</label>
									...
									<div class="tab-content">
											<div class="tab-pane fade in active" id="eng">
													...
													<label class="label">Title</label>
														<label class="input">
															<input type="text" name="text2"  value="<? echo $loaden[topic];?>">
														</label>
													</section>
													...
													<label class="label">Description</label>
														<label class="input">
															<input type="text" name="text10"  value="<? echo $loaden[value];?>">
														</label>
													</section>
													...
													<section class="col-md-12">
														...
														<div id="contenteng" name="text8"><? echo $loaden[detail];?></div>
													</section>
											</div>
											...
											<div class="tab-pane fade in " id="th">
													...
													<label class="label">Title</label>
														<label class="input">
															<input type="text" name="text2th"   value="<? echo $loadth[topic];?>">
														</label>
													</section>
													...
													<label class="label">Desciption</label>
														<label class="input">
															<input type="text" name="text10th"   value="<? echo $loadth[topic];?>">
														</label>
													</section>
													...
													<section class="col-md-12">
														<label class="label">Content</label>
														<div id="contentth" name="text8th"><? echo $loadth[detail];?></div>
													</section>
											</div>
									</div>
									</div>
		...
		function save(){
		 ...
		 var getcategory = $('#text1').val();
		 var category;
		 if (getcategory == 1) { category = "Article";}
		 else if (getcategory == 2) { category = "Tips";}
		 else if (getcategory == 3) { category = "Knowledge";}
		 else if (getcategory == 4) { category = "Populars";}

		var q = $('#contenteng').summernote('code');
		var r = $('#contentth').summernote('code');
