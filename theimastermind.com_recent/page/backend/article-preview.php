							...
							<div class="row">
									...
									<div class="tab-content">
											<div class="tab-pane fade in active" id="eng">
												...
												<div class="col-md-12">
													<header><h3><? echo $loaden["topic"]; ?></h3></header>
												</div>
											...
											<div class="tab-pane fade in " id="th">
												...
												<div class="col-md-12">
													<header><h3><? echo $loadth["topic"]; ?></h3></header>
												</div>
									...
									<a class="btn btn-u pull-right" href="article-all" > Back </a>

									</section>
									<section class="col col-3">
									
									<a class="btn btn-u pull-left" href="article-edit?idarticle=<?echo $getidarticle;?>" > Edit </a>
									</section>
									</div>
