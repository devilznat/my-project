				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="col-md-6">
								<h4><label>Picture Slide </label></h4>
							...
							<div class="col-md-6">
								<h4><label> Video </label></h4>
									<video id="myVideo"  width="100%" height="auto">
									  <source src="../../uploadfile/slide/homepage/<? echo $loadsliderhomepage[value_custom5];?>" type="video/mp4">
...
<script>
		...
		// upload file banner newsletters1 eng
		  ...
		  var uploader = new ss.SimpleUpload({
		        button: btn,
		        url: 'fileupload-image-slide9.php',
		        name: 'slidehomepage',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		  ...
		  var uploader2 = new ss.SimpleUpload({
		        button: btn2,
		        url: 'fileupload-image-slide10.php',
		        name: 'slidehomepage',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		...
		$.ajax({
		    ...
		    success:  function(data){
		        ...
		        window.location.assign("slide-home-page-editvideo?silde=<? echo $idslide; ?>");
		    }
		});
