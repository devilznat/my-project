...
<body class="header-fixed header-fixed-space">
	<div class="wrapper">
		...
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left">Banner Job-view Page</h1>
	...
	$sqlbannerjobview1 = mysql_query("SELECT * FROM banner WHERE language_code =  'en' AND location = 'banner-jobview1' " );
	$loadbannerjobview1 = mysql_fetch_array($sqlbannerjobview1 );

	$sqlbannerjobview2 = mysql_query("SELECT * FROM banner WHERE language_code =  'th' AND location = 'banner-jobview1' " );
	$loadbannerjobview2 = mysql_fetch_array($sqlbannerjobview2);
...
?>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-tasks"></i> Banner Jobview Page</h3>
						</div>
						<div class="panel-body">
							<div class="tab-v1 ">
								...
								<div class="tab-content">
									...
									<input type="text" name="type" id="type" value="banner-jobview-link1" hidden>

									<!-- banner Eng -->
									<div class="col-md-12">
										<h4><label>Banner Jobview Page 1 English</label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannerjobview1[imagename]; ?>" width="100%" height="auto">
									...
									<div class="col-md-12">
										...
										<section>
											...
											<label class="input">
												...
												<input name="textlink1" id="textlink1" type="text" value="<? echo $loadbannerjobview1[linkbanner]; ?>">
											</label>
										</section>
									...
									<input type="text" name="type" id="type" value="banner-jobview-link2" hidden>
									<!-- Banner thai -->
									<div class="col-md-12">
										<h4><label>Banner Jobview Page 1 Thai</label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannerjobview2[imagename]; ?>" width="100%" height="auto">
										<br> <h4>*Image Examples Size 1500x190px </h4>
									</div>
									<div class="col-md-12">
										<div class="row" style="padding-top:10px;">
									...
									<div class="col-md-12">
										...
										<section>
											...
											<label class="input">
												<i class="icon-prepend fa fa-link"></i>
												<input name="textlink3" id="textlink3" type="text" value="<? echo $loadbannerjobview2[linkbanner]; ?>">
											</label>
										</section>
...
<script>
		...
		// upload file banner newsletters1 eng
		  ...
		  var uploader = new ss.SimpleUpload({
		        button: btn,
		        url: 'fileupload-banner-jobview.php',
		        name: 'banner-jobview1-en',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
		  ...
		  var uploader3 = new ss.SimpleUpload({
		        button: btn3,
		        url: 'fileupload-banner-jobview2.php',
		        name: 'banner-jobview1-th',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
