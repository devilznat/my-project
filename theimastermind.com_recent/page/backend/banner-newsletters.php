...
<body class="header-fixed header-fixed-space">
	<div class="wrapper">
		...
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left">Banner Newsletter Page</h1>
...
?>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-tasks"></i> Banner Newsletters Page</h3>
						</div>
						<div class="panel-body">
							<div class="tab-v1 ">
								...
								<div class="tab-content">
									...
									<input type="text" name="type" id="type" value="banner-newsletters-link1" hidden>

									<div class="col-md-12">
									<h4><label>Banner Newsletters 1 </label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannernewsletter1[imagename]; ?>" width="100%" height="auto">
									...
									<div class="col-md-12">
										...
										<section>
											<label class="label"><h4>Url Link Banner</h4> </label>
											<label class="input">
												<i class="icon-prepend fa fa-link"></i>
												<input name="textlink1" id="textlink1" type="text" value="<? echo $loadbannernewsletter1[linkbanner]; ?>">
											</label>
										</section>
									...
									<hr>
									<h4><label>Banner Newsletters 2 </label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannernewsletter2[imagename]; ?>" width="100%" height="auto">
										<br> <h4>*Image Examples Size 500x330px </h4>
									</div>
									<div class="col-md-12">
										<div class="row" style="padding-top:10px;">
								            <div class="col-xs-2">
									...
									<div class="col-md-12">
										...
										<section>
											...
											<label class="input">
												<i class="icon-prepend fa fa-link"></i>
												<input name="textlink2" id="textlink2" type="text" value="<? echo $loadbannernewsletter2[linkbanner]; ?>">
											</label>
										</section>
										<a onclick="saveeng();" class="btn-u ">Save</a>
									...
									<input type="text" name="type" id="type" value="banner-newsletters-link2" hidden>


									<div class="col-md-12">
									<h4><label>Banner Newsletters 1 Thai </label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannernewsletter3[imagename]; ?>" width="100%" height="auto">
										<br> <h4>*Image Examples Size 1500x190px </h4>
									</div>
									<div class="col-md-12">
										<div class="row" style="padding-top:10px;">
									...
									<div class="col-md-12">
										...
										<section>
											...
											<label class="input">
												<i class="icon-prepend fa fa-link"></i>
												<input name="textlink3" id="textlink3" type="text" value="<? echo $loadbannernewsletter3[linkbanner]; ?>">
											</label>
										</section>
									...
									<hr>
									<h4><label>Banner Newsletters 2 Thai </label></h4>
										<img src="../../uploadfile/banner/<? echo $loadbannernewsletter4[imagename]; ?>" width="100%" height="auto">
										<br> <h4>*Image Examples Size 500x330px </h4>
									</div>
									<div class="col-md-12">
										<div class="row" style="padding-top:10px;">
									...
									<div class="col-md-12">
										...
										<section>
											...
											<label class="input">
												<i class="icon-prepend fa fa-link"></i>
												<input name="textlink4" id="textlink4" type="text" value="<? echo $loadbannernewsletter4[linkbanner]; ?>">
											</label>
										</section>
										<a onclick="savethai();" class="btn-u ">Save</a>
		...
		// upload file banner newsletters1 eng
		  ...
		  var uploader = new ss.SimpleUpload({
		        button: btn,
		        url: 'fileupload-banner.php',
		        name: 'banner-newsletters1-en',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
		  ...
		  var uploader2 = new ss.SimpleUpload({
		        button: btn2,
		        url: 'fileupload-banner2.php',
		        name: 'banner-newsletters2-en',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
		  ...
		  var uploader3 = new ss.SimpleUpload({
		        button: btn3,
		        url: 'fileupload-banner3.php',
		        name: 'banner-newsletters3-th',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
		  ...
		  var uploader4 = new ss.SimpleUpload({
		        button: btn4,
		        url: 'fileupload-banner4.php',
		        name: 'banner-newsletters4-th',
		        multipart: true,
		        hoverClass: 'hover',
		        focusClass: 'focus',
		        responseType: 'json',
