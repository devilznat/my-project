...
$timestamp = strtotime($loadslide1['created_date']);
...
?>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-tasks"></i> Slide Newsletter Page  </h3>
						</div>
						<div class="panel-body">

							<div class="profile-bio ">
							<div class="alert alert-success col-md-12" >
								<div class="col-md-12"><h2><strong>Slide 1 </strong></h2></div>
								<div class="col-md-12">
											<img class="img-responsive md-margin-bottom-10" src="../../uploadfile/article/<? echo $loadslide1[pic]; ?>" alt="">	
								</div>
								<div class="col-md-12">
											<br>
											<h3><strong>  </strong></h3> 
											<h4>	
												<strong>Title : </strong> <? echo $loadslide1[topic]; ?><br>	
												<strong>Article ID : </strong> <? echo $loadslide1[article_id]; ?><br>	
												<strong>Category : </strong> <? echo $loadslide1[location]; ?><br>	
							...
							<input type="text" name="type" id="type" value="slide-newsletter" hidden>
							<section class="col-md-12">
								<label class="label"><h4>Change Slide (Article ID)</h4> </label>
									<label class="input">
										<input type="text" name="idarticle" id="idarticle" value="<? echo $loadslide1[article_id]; ?>" >
									</label>
							</section>
							...
							<div class="col-md-3 pull-right">
								...
								<a class="btn-u btn-block" href="slide-newsletters" >Back</a>
							</div>	
							</form>
		...
		$.ajax({
		    ...
		    success:  function(data){
		        ...
		        window.location.assign("slide-newsletters-edit");
		    }
		});
