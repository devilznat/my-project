...
// updata database
$sql ="UPDATE  `thei_db`.`slide_homepage` SET  `value_custom5` =  '".$namefiledb."' WHERE  `slide_homepage`.`shid` =9;";
$upQuery = mysql_query($sql);

$sql1 ="UPDATE  `thei_db`.`slide_homepage` SET  `value_custom5` =  '".$namefiledb."' WHERE  `slide_homepage`.`shid` =10;";
