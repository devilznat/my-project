...
$namefile  ="bannerhomepage".$rando.".";


$upload_dir = '../../assets/img/icons/testimonials/';
$Upload = new FileUpload('edit-logo-testimonials');
...
// updata database
$sql ="UPDATE  `thei_db`.`testimonials_detail` SET  `value_custom2` =  '".$namefiledb."' WHERE  `testimonials_detail`.`tdid` ='".$getid."';";
