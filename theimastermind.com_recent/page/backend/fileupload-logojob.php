...
$namefile  ="joblogo".$rando.".";


$upload_dir = '../../assets/img/job/';
$Upload = new FileUpload('logojob');
...
// updata database
$sql ="UPDATE  `thei_db`.`jobs_value` SET  `value_custom` =  '".$namefiledb."' WHERE  `jobs_value`.`job_id` ='$idjob';";
