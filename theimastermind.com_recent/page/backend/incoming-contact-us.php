...
//*** Update Last Stay in Login System
  ...
  $gettext = $_GET['textsearch'];
   ...
   if ($status==0) {
  		$number="SELECT * FROM contact_msg ";

  	# code...
  } else {
  		$number="SELECT * FROM contact_msg WHERE name like '%$gettext%' ";
  	# code...
  }
...
$start=($page-1)*$rows;
  ...
  if ($status==0) {
  		...
  		$sql = "SELECT * FROM contact_msg ORDER BY id DESC limit $start,5";
  	# code...
  } 

  else {

  	$sql = "SELECT * FROM contact_msg WHERE name like '%$gettext%'  ORDER BY id DESC limit $start,5";
  }
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Search Contact Us</h3>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"> Find Contact Us Data</h3>
						</div>
						<div class="panel-body">
							<div class="col-md-12">
							<table class="table">
	...
	$i++;
		...
		?>
									<tr>
										...
										<td width="20%"><? echo $rs["created_date"]; ?></td>
	
										<td width="30%">
										<b>Name : </b><? echo $rs["name"]; ?>  <? echo $rs["surname"]; ?>
										<br>
										<b>Company : </b><? echo $rs["company_name"]; ?> 
										<br> 
										...
										<td width="50%">
										<font color="#446cb3"><b><? echo $rs["subject"]; ?></b></font><br>
										<? echo $rs["message"]; ?></td>
										<!-- <td>
  ...
  <ul class="pagination">
    ...
    <?
    		...
    		if ($status == 0 ) {
    			...
    			$pagenumback = "incoming-contact-us?page=".$numback;
  				
    		} else {
    			
    			$pagenumback = "incoming-contact-us?search=1&textsearch=".$gettext."&page=".$numback;
    			# code...
    		}
    ...
    <?
    		...
    		if ($status == 0 ) {
    			...
    			$pagenumnext = "incoming-contact-us?page=".$i;
  				
    		} else {
    		
    			$pagenumnext = "incoming-contact-us?search=1&textsearch=".$gettext."&page=".$i;
    			# code...
    		}
...
<script type="text/javascript">
			...
			function Searchjob(event,form){
				...
				url = "incoming-contact-us?search="+search+"&textsearch="+textsearch;
