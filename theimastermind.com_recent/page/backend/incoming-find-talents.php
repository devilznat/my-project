...
//*** Update Last Stay in Login System
  ...
  if ($status==0) {
  		$number="SELECT * FROM find_peoples ";

  	# code...
  } else {
  		$number="SELECT * FROM find_peoples WHERE name like '%$gettext%' ";
  	# code...
  }
...
$start=($page-1)*$rows;
  ...
  if ($status==0) {
  		...
  		$sql = "SELECT * FROM find_peoples ORDER BY id DESC limit $start,5";
  	# code...
  } 

  else {

  	$sql = "SELECT * FROM find_peoples WHERE name like '%$gettext%'  ORDER BY id DESC limit $start,5";
  }
...
?>
	<div class="wrapper">
		...
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="pull-left">Find Talents Page</h1>
				...
				<div class="col-md-9">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Search Find Talents</h3>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"> Find Talents Data</h3>
						</div>
						<div class="panel-body">
							<div class="col-md-12">
							<table class="table">
	...
	$i++;
		...
		?>
									<tr>
										...
										<td width="30%">
										<b>Name : </b><? echo $rs["name"]; ?>
										<br>
										<b>Position : </b><font color="#446cb3"><? echo $rs["position"]; ?></font>
										<br>
										<b>Country : </b><? echo $rs["country"]; ?> 
										<br> 
										<b>E-mail : </b><? echo $rs["email"]; ?> 
										<br> 
										<b>Phone : </b><? echo $rs["tel"]; ?>
										</td>
  ...
  <ul class="pagination">
    ...
    <?
    		...
    		if ($status == 0 ) {
    			...
    			$pagenumback = "incoming-find-talents?page=".$numback;
  				
    		} else {
    			
    			$pagenumback = "incoming-find-talents?search=1&textsearch=".$gettext."&page=".$numback;
    			# code...
    		}
    ...
    <li <? if($page==$i) echo 'class="page-item active"';?>>
     ...
     <?
    		...
    		if ($status == 0 ) {
    			...
    			$pagenumnext = "incoming-find-talents?page=".$i;
  				
    		} else {
    		
    			$pagenumnext = "incoming-find-talents?search=1&textsearch=".$gettext."&page=".$i;
    			# code...
    		}
...
<script type="text/javascript">
			...
			function Searchjob(event , form){
				...
				url = "incoming-find-talents?search="+search+"&textsearch="+textsearch;
