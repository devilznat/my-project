							...
							<div class="tab-v1 ">
								...
								<div class="tab-content">
									...
									<!-- Testimonials eng -->
										...
										<input type="text" name="type" id="type" value="testimonials-add" hidden>

										

										<section class="col-md-12">
											<label class="label"><h4>Status Testimonials - English</h4> </label>
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text1"  id="text1" rows="1" >Ex. Candidate</textarea>
											</label>
										</section>	

										<section class="col-md-12">
											<label class="label"><h4>Status Testimonials - Thai</h4> </label>
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text2"  id="text2" rows="1" >Ex. Candidate</textarea>
											</label>
										</section>	
										...
										<section class="col-md-12">
											...
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text3"  id="text3" rows="3" >Ex. Telecommunication Industry</textarea>
											</label>
										</section>	
										...
										<section class="col-md-12">
											...
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text4"  id="text4" rows="3" >Ex. Telecommunication Industry</textarea>
											</label>
										</section>	
										<div class="col-md-12"><HR></div>
										...
										<section class="col-md-12">
											...
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text5"  id="text5"  rows="5" >Ex. iMastermind gives the service with service minded with the impressive care in client’s detail. </textarea>
											</label>
										</section>
										...
										<section class="col-md-12">
											...
											<label class="textarea">
												<i class="icon-append fa fa-comment"></i>
												<textarea name="text6"  id="text6"  rows="5" >Ex. iMastermind gives the service with service minded with the impressive care in client’s detail. </textarea>
											</label>
										</section>
										<div class="col-md-12"><HR></div>
										<div class="col-md-12">
										<label class="label"><h4>Image Testimonials  </h4> Image Size * 360x360px</label>
										...
										<div class="col-md-12"><HR></div>
										<div class="col-md-3">
											<button class="btn-u btn-block " onclick="save()" >Save</button>
										</div>	
										<div class="col-md-3 pull-right">
											<a class="btn-u btn-block " href="testimonials" >Back</a>
										</div>				
									</form>
									<!-- Testimonials eng -->
...
<script>
		...
		// upload file banner newsletters1 eng
		  ...
		  var uploader = new ss.SimpleUpload({
		        button: btn,
		        url: 'fileupload-image-testimonals.php',
